...
/**
 * Helper class for showing and canceling input notifications.
 * <p>
...
public class InputNotification {
	 ...
	 */
	private static final String NOTIFICATION_TAG = "Input";
	 ...
	 * presentation of input notifications. Make sure to follow the <a
...
//		editor.commit();
		...
		final NotificationCompat.Builder builder = new NotificationCompat.Builder(
				...
				.setSmallIcon(R.drawable.ic_stat_input)
				...
				.setContentIntent(
						PendingIntent.getActivity(
								context,
								0,
								new Intent(context,Statistic.class),
